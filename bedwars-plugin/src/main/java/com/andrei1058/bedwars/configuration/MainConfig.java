...
public class MainConfig extends ConfigManager {
    ...
    public MainConfig(Plugin plugin, String name) {
        ...
        saveLobbyCommandItem("stats", "bw stats", false, "SKULL_ITEM", 3, 0);
        saveLobbyCommandItem("arena-selector", "bw gui", true, "CHEST", 5, 4);
        saveLobbyCommandItem("leave", "bw leave", false, "BED", 0, 8);

        /* Pre Game Command Items */
        savePreGameCommandItem("stats", "bw stats", false, "SKULL_ITEM", 3, 0);
        savePreGameCommandItem("leave", "bw leave", false, "BED", 0, 8);

        /* Spectator Command Items */
        saveSpectatorCommandItem("teleporter", "bw teleporter", false, "SKULL_ITEM", 3, 0);
        saveSpectatorCommandItem("leave", "bw leave", false, "BED", 0, 8);
        ...
        yml.addDefault(ConfigPath.GENERAL_CONFIGURATION_ARENA_SELECTOR_STATUS_MATERIAL.replace("%path%", "waiting"), "STAINED_GLASS_PANE");
        ...
        yml.addDefault(ConfigPath.GENERAL_CONFIGURATION_ARENA_SELECTOR_STATUS_MATERIAL.replace("%path%", "starting"), "STAINED_GLASS_PANE");
        ...
        yml.addDefault(ConfigPath.GENERAL_CONFIGURATION_ARENA_SELECTOR_STATUS_MATERIAL.replace("%path%", "playing"), "STAINED_GLASS_PANE");
        ...
        yml.addDefault(ConfigPath.GENERAL_CONFIGURATION_ARENA_SELECTOR_STATUS_MATERIAL.replace("%path%", "skipped-slot"), "STAINED_GLASS_PANE");
        ...
        if (isFirstTime()) {
            ...
            Misc.addDefaultStatsItem(yml, 13, Material.valueOf("SKULL_ITEM"), 0, "deaths");
            Misc.addDefaultStatsItem(yml, 14, Material.DIAMOND_SWORD, 0, "final-kills");
            Misc.addDefaultStatsItem(yml, 15, Material.valueOf("SKULL_ITEM"), 1, "final-deaths");
            Misc.addDefaultStatsItem(yml, 16, Material.valueOf("BED"), 0, "beds-destroyed");
            Misc.addDefaultStatsItem(yml, 21, Material.valueOf("STAINED_GLASS_PANE"), 0, "first-play");
            Misc.addDefaultStatsItem(yml, 22, Material.CHEST, 0, "games-played");
            Misc.addDefaultStatsItem(yml, 23, Material.valueOf("STAINED_GLASS_PANE"), 0, "last-play");
        }
